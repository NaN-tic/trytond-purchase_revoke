...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_revoke',
    download_url='https://github.com:nantic/trytond-purchase_revoke.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_revoke.git'
    },
    classifiers=[
